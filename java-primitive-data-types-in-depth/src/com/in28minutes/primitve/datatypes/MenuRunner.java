...
//		System.out.println("The number you entered in: " + number1);
	...
	private static void performOperationUsingNestedIfElse(int number1, int number2, int choice) {
		if (choice == 1) {
			...
			System.out.println("You've entered an incorrect entry");
	}

	private static void performOperationUsingSwitch(int number1, int number2, int choice) {

		switch (choice) {
		case 1: System.out.println("Results " + (number1 + number2));
			break;
		case 2: System.out.println("Results " + (number1 - number2));
			break;
		case 3: System.out.println("Results " + (number1 / number2));
			break;
		case 4: System.out.println("Results " + (number1 * number2));
			break;
